...
libs="libbrotlicommon libgraphite2 libjpeg libbrotlidec libharfbuzz libpng16 libXrender libfontconfig libfreetype libXext libX11 libxcb libXau libexpat libuuid libbz2"
